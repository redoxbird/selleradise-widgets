...
<div
  ...
  <?php if(isset($settings['split_pattern']) && $settings['split_pattern'] === 'slant'): ?>
    <div 
      class="relative px-page mb-10 lg:mb-0 z-30 bg-background-50 flex w-full lg:w-1/2 flex-grow flex-col justify-center items-start"
    ...
    <span class="absolute h-[200%] top-1/2 -translate-y-1/2 right-[38%] w-120 bg-background-50 rotate-[25deg] z-20"></span>
