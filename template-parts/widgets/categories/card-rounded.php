...
<li
  ...
  x-transition>
  <a
    class="w-full h-full flex flex-col justify-center items-center border-text-100 border-1 border-solid p-4 rounded-2xl hover:border-text-300"
