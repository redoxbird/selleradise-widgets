...
<li 
  ...
  <a 
    ...
    <div class="relative z-10 flex justify-center items-center overflow-hidden rounded-2xl h-ratio hover:children:scale-110">
      <?php selleradise_widgets_get_template_part('template-parts/widgets/categories/partials/image', null, ["category" => $category]); ?>
    </div>

    <h3 class="relative bg-text-900 text-background-50 px-4 py-1.5 rounded-full -mt-4 text-center text-xs z-20">
